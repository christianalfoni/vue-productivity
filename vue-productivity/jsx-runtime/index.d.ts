...
/**
 * Based on JSX ptyes for Surplus and Inferno and adapted for `dom-expressions`.
 *
...
/**
  - Copy the jsx.d.ts file from dom-expressions
  - TS-MORPH:
    - Add key?: PropertyKey to IntrinsicAttributes and CustomAttributes
    - Remove existing ref?: from IntrinsicAttributes and CustomAttributes
    - Add ref?: VNodeRef to IntrinsicAttributes and CustomAttributes
    - Remove children: from ElementChildrenAttribute
    - Add slots: {} to ElementChildrenAttribute
 */
